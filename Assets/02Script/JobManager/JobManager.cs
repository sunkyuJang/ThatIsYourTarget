...
public class JobManager
{
    ...
    public JobManager(object section, Action afterFinishJobManager)
    {
        this.section = section;
        this.AfterFinishJobManager = afterFinishJobManager;
    }
    public JobManager(Action afterFinishJobManager)
    {
        this.AfterFinishJobManager = afterFinishJobManager;
    }
