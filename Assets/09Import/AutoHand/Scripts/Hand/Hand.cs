...
namespace Autohand
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public static string TagName { get { return "Hand"; } }
        [Header("Fingers")]
        ...
        public Transform GetMoveTo { get { return moveTo; } }
        ...
        void MakeMoveTo()
        {
            ...
            var collider = moveTo.gameObject.AddComponent<SphereCollider>();
            collider.radius = 0.01f;
            collider.center = GrabPosition.transform.localPosition;
            collider.isTrigger = true;
            collider.tag = "HandPosition";
